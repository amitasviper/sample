 ...
 * Input	   : @liftLED = Value of GPIO PIN (in the form of string)
 * Return	   : None
 * Note		   : This function is called for every traffic signal liftLED
 *************************************************************************************/
...
void seekAllButtons(void)
{
	...
	for(i=0; i<NO_OF_FLOORS; i++)					/* Run a loop for all floors */
	{
		...
		lseek(floor_set[i].fd, 0, SEEK_SET);		/* Seek a current fd to 0th position means fd will point at brgining of the file */
